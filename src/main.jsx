  ...
  if (isLoading) {
    return (
      ...
      >
        {/* Background Blur */}
        <div
          className="absolute inset-0 bg-[#00bfff0f] blur-[80px] -z-10"
          aria-hidden="true"
        />

        {/* Shine Ring */}
        <div
          className="absolute w-40 h-40 rounded-full bg-[#00bfff30] -z-20"
          aria-hidden="true"
        />
        ...
        {/* Title */}
        <h1 className="mt-4 text-2xl font-semibold z-10 text-inherit">
          Tech Quanta
        </h1>
