...
export const NavBody = ({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full border-b-[2px] border-gray-400 px-4 py-2 lg:flex dark:bg-[#121212] bg-[#121212] ",
